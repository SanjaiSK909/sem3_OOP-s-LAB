...
class PATIENT{
 ...
 public:
    PATIENT():Patient_ID(0),Patient_name("Don't know"),Age(0),Disease("Don't know"),Blood_group("Don't know"),Doctor_ID(0){};
...
class DOCTOR{
    ...
    public:
    DOCTOR():Doc_id(0),Doctor_name("Don't know"),Specialization("Don't know"){};
...
int main(){
    PATIENT P[]={
    PATIENT(1,"SANJAI SK",19,"Fever","B+",901),
    PATIENT(2,"TOM",25,"JAUNDICE","AB+",100),
    PATIENT(3,"JERRY ",19,"EAR PAIN","B-",201),
    PATIENT(4,"JACKIEE CHAN",35,"EYE PAIN","O+",222),
    PATIENT(5,"JULLY",12,"COUGH & COLD","A+",100),
    PATIENT(6,"DORA",18,"SMALL POX","B+",100),
    PATIENT(7,"BUJJI",30,"SPRAIN","AB-",901)
     };
   
   int patient_size=sizeof(P)/sizeof(P[0]);
   
   DOCTOR D[]={
    DOCTOR(901,"Dr.SANJAI KUMAR","E.N.T"),
    DOCTOR(100,"Dr.HEMALTHA","GENERAL"),
    DOCTOR(201,"Dr.SIVAKUMAR","OPTHOMOLOGY"),
    DOCTOR(222,"Dr.VOSHINI","ORTHOPEDIC"),
    DOCTOR(300,"Dr.JAI","NEURO")
   };

   int doctor_size=sizeof(D)/sizeof(D[0]);
